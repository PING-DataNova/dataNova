...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column('include_weather_alerts', sa.Boolean(), nullable=False, server_default='1'),
        sa.Column('include_regulatory', sa.Boolean(), nullable=False, server_default='1'),
        sa.Column('include_geopolitical', sa.Boolean(), nullable=False, server_default='1'),
